...
2. Build the lab environment automatically:
   ...
   vagrant up
    ```
3. Establish your attack terminal connection:
    ```bash
   vagrant ssh kali
   ```
...
4. To start the simulation, jump into the compromised web application boundaries to initiate the Phase 1 vector:
   ```bash
